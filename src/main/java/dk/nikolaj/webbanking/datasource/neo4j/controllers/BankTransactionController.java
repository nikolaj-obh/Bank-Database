package dk.nikolaj.webbanking.datasource.neo4j.controllers;

import dk.nikolaj.webbanking.datasource.neo4j.model.BankTransaction;
import dk.nikolaj.webbanking.datasource.neo4j.service.interfaces.BankTransactionService;
...
@RestController("Neo4jBankTransactionController")
@RequestMapping("/neo4j-banking-transactions")
