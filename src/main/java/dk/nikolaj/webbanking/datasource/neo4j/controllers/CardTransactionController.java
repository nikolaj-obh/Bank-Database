...
import dk.nikolaj.webbanking.datasource.neo4j.service.interfaces.CardTransactionService;
...
@RestController("Neo4jCardTransactionController")
@RequestMapping("/neo4j-card-transactions")
